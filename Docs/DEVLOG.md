...
Why Lacunarity/Gain: with gain=0.5, octave *N* contributes only `0.5^N` of the total — going 6→8 octaves was barely visible (~1.6% vs ~0.4% contribution). Exposing gain lets higher octaves actually matter.
